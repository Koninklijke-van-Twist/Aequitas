...
const TRANSLATIONS = [
    'nl' => [
        ...
        'aequitas.hero.subtitle' => 'Vergelijk laatste directe kosten met actieve prijslijstregels.',
        ...
        'aequitas.empty.rows' => 'Geen actieve prijslijstregels gevonden voor deze selectie.',
    ...
    'en' => [
        ...
        'aequitas.hero.subtitle' => 'Compare last direct cost with active price list lines.',
        ...
        'aequitas.empty.rows' => 'No active price list lines found for this selection.',
    ...
    'de' => [
        ...
        'aequitas.hero.subtitle' => 'Vergleich letzter direkter Kosten mit aktiven Preislistenzeilen.',
        ...
        'aequitas.empty.rows' => 'Keine aktiven Preislistenzeilen für diese Auswahl gefunden.',
    ...
    'fr' => [
        ...
        'aequitas.hero.subtitle' => 'Comparer le dernier coût direct avec les lignes de tarif actives.',
        ...
        'aequitas.empty.rows' => 'Aucune ligne de tarif active trouvée pour cette sélection.',
