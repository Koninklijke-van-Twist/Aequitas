...
const TRANSLATIONS = [
    'nl' => [
        ...
        'app.title' => 'Seshat',
        'seshat.hero.title' => 'Timesheet direct/indirect',
        ...
        'seshat.legend.productive' => 'Direct',
        'seshat.legend.unproductive' => 'Indirect',
        ...
        'seshat.col.avg_productivity' => 'Gem. % direct per week',
        'seshat.col.productivity' => '% Direct',
        'seshat.day.mon' => 'Ma',
        'seshat.day.tue' => 'Di',
        'seshat.day.wed' => 'Wo',
        'seshat.day.thu' => 'Do',
        ...
        'seshat.modal.hours_productive' => 'direct',
    ],
    ...
    'en' => [
        ...
        'seshat.col.avg_productivity' => 'Avg. % direct per week',
        'seshat.col.productivity' => '% Direct',
        'seshat.day.mon' => 'Mon',
        'seshat.day.tue' => 'Tue',
        'seshat.day.wed' => 'Wed',
    ...
    'de' => [
        ...
        'app.title' => 'Seshat',
        'seshat.hero.title' => 'Timesheet direkt/indirekt',
        ...
        'seshat.legend.productive' => 'Direkt',
        'seshat.legend.unproductive' => 'Indirekt',
        ...
        'seshat.col.avg_productivity' => 'Ø % direkt pro Woche',
        'seshat.col.productivity' => '% Direkt',
        'seshat.day.mon' => 'Mo',
        'seshat.day.tue' => 'Di',
        'seshat.day.wed' => 'Mi',
        'seshat.day.thu' => 'Do',
        ...
        'seshat.modal.hours_productive' => 'direkt',
    ],
    ...
    'fr' => [
        ...
        'app.title' => 'Seshat',
        'seshat.hero.title' => 'Feuille de temps direct/indirect',
        ...
        'seshat.col.avg_productivity' => '% direct moy. par semaine',
        'seshat.col.productivity' => '% Direct',
        'seshat.day.mon' => 'Lu',
        'seshat.day.tue' => 'Ma',
        'seshat.day.wed' => 'Me',
